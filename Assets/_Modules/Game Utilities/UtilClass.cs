...
public static class UtilClass {
    ...
    public static void ShakeCamera(float duration, float strength = 3f, int vibrato = 10, float randomness = 90f, bool fadeOut = true, ShakeRandomnessMode randomnessMode = ShakeRandomnessMode.Full) {
        Camera.main.DOShakePosition(duration, strength, vibrato, randomness, fadeOut, randomnessMode);
    }

    public static void PlayTransformFadeOutAnimation(Transform transform, CanvasGroup canvasGroup = null, 
    Action onComplete = null, float toScale = 1.2f, float scaleDuration = 0.2f, float fadeDuration = 0.2f) {
    ...
    public static Transform CloneTransform(Transform transform, Transform newParent, string name = null) {
        Transform clone = UnityEngine.Object.Instantiate(transform, newParent);
